...
setup(
    ...
    packages=['health_check', 'health_check_celery', 'health_check_db', 'health_check_cache', 'health_check.backends','health_check.management','health_check.management.commands', 'health_check_storage'],
